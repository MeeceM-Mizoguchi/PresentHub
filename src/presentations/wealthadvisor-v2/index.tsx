...
export const wealthadvisorV2Presentation: PresentationEntry = {
  meta: {
    ...
    title: '投資信託レポート／ニュース記事 AI自動生成システム ご提案（改訂版）',
    description:
      'ウェルスアドバイザー社向け・改訂版（全10枚）。収集・生成・チェックをAIで自動化し、承認は人が担保する仕組みのご提案。現状の課題／機械学習による精度向上／開発スケジュール（9月末リリース）／フェーズ1〜3のロードマップ／概算見積850万円・4名体制 まで収録。',
